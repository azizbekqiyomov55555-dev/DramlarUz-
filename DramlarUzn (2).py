...
async def _send_kino_list_page(bot, chat_id: int, page: int = 0):
    ...
    nav_row  = []
    if page > 0:
        nav_row.append(ibtn(f"⬅️ Oldingi kinolar", data=f"kino_list|{page - 1}", style="primary"))
    if page < total_pages - 1:
        nav_row.append(ibtn(f"🎬 Qolgan kinolar", data=f"kino_list|{page + 1}", style="primary"))
