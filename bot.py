...
# ─── Supabase (ikkinchi zaxira baza) ────────────────────────
# Jadval: bot_storage (id int8 primary key, data jsonb)
# Bitta qator (id=1) butun bot bazasini saqlaydi.
SUPABASE_URL    = "https://ccnthdzllhdcjpzmehqa.supabase.co"
SUPABASE_KEY    = "sb_publishable_1MQ5Ar_fqFblO1upgygjOw_Pu08CxJs"
...
def db_load():
    """Avval JSONBlob → Supabase → lokal backup tartibida yuklaydi."""
    global _load_ok
    ...
    logger.error("❌ Hech qaerdan DB yuklab bo'lmadi! Saqlash bloklandi.")
