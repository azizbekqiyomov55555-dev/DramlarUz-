...
def save():
    # Sync saqlash: JSONBin'ga to'liq yozib bo'lguncha kutadi.
    # Bot reset bo'lsa ham qo'shilgan kino/emoji yo'qolmaydi.
    ok = db_save(DB)
    if not ok:
        logger.error("DB save FAILED â€” ma'lumotlar JSONBin'ga yozilmadi!")
    return ok
