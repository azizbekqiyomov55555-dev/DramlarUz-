        ...
        try:
            async with aiohttp.ClientSession() as session:
                async with session.put(
                    ...
                    if resp.status == 200:
                        logger.info("DB saqlandi (JSONBin + backup)")
                        return True
                    else:
                        txt = await resp.text()
...
def channel_manage_kb():
    ...
    return rkb([
        ...
        [rbtn("ï¸ Admin panel", style="success")],
    ])
